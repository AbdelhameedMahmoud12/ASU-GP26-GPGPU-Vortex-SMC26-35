...
set top_module VX_schedule

########################### Formality Setup file ############################

set_svf "VX_schedule.svf"
...
analyze -format $file_format [glob /home/IC/schedule/interfaces/*.sv]


# 3. Now analyze all other sub-modules

analyze -format $file_format [glob /home/IC/schedule/rtl/*.sv]



elaborate -lib work VX_schedule
...
write_file -format verilog -hierarchy -output VX_schedule_netlist.v
write_file -format ddc -hierarchy -output VX_schedule_netlist.ddc
write_sdc  -nosplit VX_schedule.sdc
write_sdf           VX_schedule.sdf

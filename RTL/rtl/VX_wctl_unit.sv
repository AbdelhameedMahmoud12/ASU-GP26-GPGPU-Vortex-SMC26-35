...
`endif
    localparam BARRIER_SIZE_W = $bits(barrier.size_m1);
    assign barrier.size_m1  = rs2_data[BARRIER_SIZE_W-1:0] - BARRIER_SIZE_W'(1);
    assign barrier.is_noop  = (rs2_data[BARRIER_SIZE_W-1:0] == BARRIER_SIZE_W'(1));

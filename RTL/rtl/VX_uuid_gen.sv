...
module VX_uuid_gen import VX_gpu_pkg::*; #(
    ...
    localparam GNW_WIDTH = (UUID_WIDTH > 32) ? (UUID_WIDTH - 32) : 1;
    ...
    assign uuid = (UUID_WIDTH > 32) ? {g_wid, (has_uuid_cntrs[wid] ? uuid_cntrs[wid] : 32'b0)} : (has_uuid_cntrs[wid] ? uuid_cntrs[wid][UUID_WIDTH-1:0] : '0);

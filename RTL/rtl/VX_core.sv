...
`endif
    ...
    `endif
        .lsu_mem_if    (lsu_mem_if),
        .dcache_bus_req_valid  (dcache_bus_req_valid),
        .dcache_bus_req_rw     (dcache_bus_req_rw),
        .dcache_bus_req_addr   (dcache_bus_req_addr),
        .dcache_bus_req_data   (dcache_bus_req_data),
        .dcache_bus_req_byteen (dcache_bus_req_byteen),
        .dcache_bus_req_flags  (dcache_bus_req_flags),
        .dcache_bus_req_tag    (dcache_bus_req_tag),
        .dcache_bus_req_ready  (dcache_bus_req_ready),
        .dcache_bus_rsp_valid  (dcache_bus_rsp_valid),
        .dcache_bus_rsp_data   (dcache_bus_rsp_data),
        .dcache_bus_rsp_tag    (dcache_bus_rsp_tag),
        .dcache_bus_rsp_ready  (dcache_bus_rsp_ready)
    );

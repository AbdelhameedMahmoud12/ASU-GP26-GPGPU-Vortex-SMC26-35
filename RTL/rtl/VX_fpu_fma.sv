...
`ifdef ASIC
    ...
    // ASIC path: pure-RTL FP32 FMA — see VX_fma_unit.sv
    for (genvar i = 0; i < NUM_PES; ++i) begin : g_fmas
        wire [31:0] fma_result_w;
        wire [`FP_FLAGS_BITS-1:0] fma_fflags_w;
        ...
        VX_fma_unit #(
            ...
            .reset    (reset),
            .enable   (pe_enable),
            .frm      (pe_data_in[0][96 +: INST_FRM_BITS]),
            .a        (pe_data_in[i][0  +: 32]),
        ...
        assign pe_data_out[i][0  +: 32]              = fma_result_w;
        assign pe_data_out[i][32 +: `FP_FLAGS_BITS]  = fma_fflags_w;
    end

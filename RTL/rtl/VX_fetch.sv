...
module VX_fetch import VX_gpu_pkg::*; #(
    ...
    // Icache interface
    VX_icache_bus_if.master    icache_bus_if,
...
`endif
    ...
    wire [ICACHE_ADDR_WIDTH + ICACHE_TAG_WIDTH - 1:0] req_buf_out;
    ...
    VX_elastic_buffer #(
        ...
        .data_out  (req_buf_out),
        .valid_out (icache_bus_if.req_valid),
        .ready_out (icache_bus_if.req_ready)
    );

    assign icache_bus_if.req_addr = req_buf_out[ICACHE_TAG_WIDTH +: ICACHE_ADDR_WIDTH];
    assign icache_bus_if.req_tag  = req_buf_out[ICACHE_TAG_WIDTH-1:0];

    assign icache_bus_if.req_flags  = '0;
    assign icache_bus_if.req_rw     = 0;
    assign icache_bus_if.req_byteen = '1;
    ...
    assign fetch_if.data.instr = icache_bus_if.rsp_data;
...
`ifdef DBG_SCOPE_FETCH
    ...
    `SCOPE_TAP_EX (0, 1, 6, 3, (
            ...
            icache_bus_if.req_tag[ICACHE_TAG_WIDTH-1 : ICACHE_TAG_WIDTH - `UP(UUID_WIDTH)], icache_bus_if.req_byteen, icache_bus_if.req_addr,
            icache_bus_if.rsp_tag[ICACHE_TAG_WIDTH-1 : ICACHE_TAG_WIDTH - `UP(UUID_WIDTH)], icache_bus_if.rsp_data
        },
...
`ifdef DBG_SCOPE_FETCH
    ila_fetch ila_fetch_inst (
        ...
        .probe1 ({icache_bus_if.req_valid, icache_bus_if.req_rw, icache_bus_if.req_addr, icache_bus_if.req_data, icache_bus_if.req_byteen, icache_bus_if.req_flags, icache_bus_if.req_tag, icache_bus_if.req_ready}),
        .probe2 ({icache_bus_if.rsp_valid, icache_bus_if.rsp_data, icache_bus_if.rsp_tag, icache_bus_if.rsp_ready})
    );
`endif
`endif
